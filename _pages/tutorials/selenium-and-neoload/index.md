...
If when you go to compile your project as an executable JAR and you do not see any 'Launch configuration'
 entries, it is likely that you did not run and verify your Selenium test. To do so, [read this thread](https://stackoverflow.com/questions/3224364/launch-configuration-shows-up-blank-when-trying-to-export-runnable-jar/3224505).

# Experimental Selenium Server for supporting WebDriver in any language
